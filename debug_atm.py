...
def debug_tradier_atm(symbol="SPY", expiration="260320"):
    ...
    price = resp.json().get("quotes", {}).get("quote", {}).get("last", 600.0)
    ...
    try:
        ...
        for opt in options:
            ...
            if parsed and abs(parsed['strike'] - price) < 10:
...
if __name__ == "__main__":
    debug_tradier_atm("SPY") # Use SPY for easier ATM finding
